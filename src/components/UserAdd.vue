    ...
    <div id="userAdd" class="userAdd">
        ...
        <div class="form_wrapper">
            <div class="cm_inner">
                ...
                <input type="Number" placeholder="请输入您的年龄" class="cm_input" v-model="formData.age"/>
            </div>
            <div class="cm_inner">
                <label class="cm_label">传真</label>
                <input type="text" placeholder="请输入您的传真" class="cm_input" v-model="formData.fax"/>
            </div>
            <div class="cm_inner">
                <label class="cm_label">地址</label>
                <input type="text" placeholder="请输入您的地址" class="cm_input" v-model="formData.line1"/>
            </div>
            <div class="cm_inner">
                <label class="cm_label">手机号码</label>
                <input type="text" placeholder="请输入您的手机号码" class="cm_input" v-model="formData.mobile" maxlength="11"/>
            </div>
            <div class="cm_inner">
